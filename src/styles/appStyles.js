...
.rafiki-app .rafa-admin-panel {
  display: grid;
  gap: 16px;
}

.rafiki-app .rafa-panel-grid {
  grid-template-columns: repeat(auto-fit, minmax(190px, 1fr));
  gap: 12px;
}

.rafiki-app .rafa-panel-link {
  width: 100%;
  text-align: left;
...
.rafiki-app .rafa-panel-link.active {
  border-color: #f59e0b;
  box-shadow: 0 0 0 2px rgba(245, 158, 11, 0.16);
}

.rafiki-app .rafa-panel-link-icon {
  font-size: 1.35rem;
  line-height: 1;
}

.rafiki-app .rafa-panel-link p {
  margin: 4px 0 0;
}
