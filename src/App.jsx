...
export default function App() {
  ...
  async function guardarMenu() {
    ...
    try {
      ...
      if (errorDesactivar) {
        mostrarMensajeMenu(`✅ Menú guardado correctamente. Aviso: no se pudieron desactivar menús anteriores: ${errorDesactivar.message}`, "warning");
      } else {
        mostrarMensajeMenu(
          eraEdicion
      ...
      mostrarMensajeMenu(
        `No se pudo guardar el menú. Revisa la conexión e intenta nuevamente. ${error.message || ""}`.trim(),
        "error"
      );
    } finally {
