...
export const MENSAJES_PEDIDOS = {
  ...
  CLAVE_INCORRECTA_ELIMINAR: "Clave incorrecta. El pedido no fue eliminado.",
};
...
export const CONFIRMACIONES_PEDIDOS = {
  ...
  claveEliminarPedido: (codigoPedido) => `Ingresa la clave para borrar el pedido #${codigoPedido}:`,
};
