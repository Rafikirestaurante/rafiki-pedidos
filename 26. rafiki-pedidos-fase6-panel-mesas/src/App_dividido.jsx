...
export default function App() {
  ...
  async function registrarPedido() {
    ...
    if (vista === "mesas") {
      if (!mesa.trim()) camposFaltantes.push("mesa");
      if (!mesero.trim()) camposFaltantes.push("mesero");
    } else {
    ...
    const clienteNombre = vista === "mesas" ? `Mesa ${mesa}` : cliente.trim();
    ...
    const nuevoPedido = {
      ...
      ubicacion: vista === "mesas" ? `Mesa ${mesa}` : (ubicacion.trim() || "Ubicación pendiente"),
      tipo_pago: tipoPago,
      ...
      tipo_pedido: vista === "mesas" ? "mesa" : "domicilio",
      mesa: vista === "mesas" ? mesa : null,
      mesero: vista === "mesas" ? mesero.trim() : null
    };
    ...
    <>
      ...
      <div className="app">
        <div className="container">
          ...
          {!cargando && (vista === "cliente" || vista === "mesas") && (
                ...
                <div className="section">
                  ...
                  <>
                      <div style={{ marginBottom: 18 }}>
                        <h3>{vista === "mesas" ? "🍽️ Pedido de mesa" : "🛍️ Arma tu pedido paso a paso"}</h3>
                        <p className="muted">{vista === "mesas" ? "Selecciona productos y envía el pedido." : "Primero selecciona tu proteína. Luego aparecerán los siguientes pasos."}</p>
                      </div>
                ...
                {!hayProductoSeleccionado ? (
                  ...
                  <>
                    ...
                    <div id="paso-datos-entrega" className="step-title" style={{ marginTop: 18 }}>
                      ...
                      <div>
                        <h4>{vista === "mesas" ? "Datos de mesa" : "Datos de entrega"}</h4>
                      </div>
                    </div>
