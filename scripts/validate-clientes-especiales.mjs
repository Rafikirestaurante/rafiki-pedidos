...
contiene(
  ...
  "ruta === '/' || ruta === '/cliente' || ruta === '/pedido'",
  "/cliente se mantiene como link público sin depender de PWA"
);
contiene(
  "src/main.jsx",
  "prepararClientePublicoSinServiceWorker",
  "main.jsx limpia service worker en rutas públicas de cliente"
);
...
contiene(
  ...
  "el recuadro valida código mediante servicio/RPC"
);
contiene(
  "src/modules/cliente/components/CodigoClienteEspecial.jsx",
  "RafikiModal",
  "la bienvenida usa RafikiModal"
);
contiene(
  "src/modules/cliente/components/CodigoClienteEspecial.jsx",
  "Gracias por preferirnos. Ya puedes continuar con tu pedido.",
  "el modal muestra el mensaje final aprobado"
);
contiene(
  "src/modules/cliente/components/CodigoClienteEspecial.jsx",
  "Continuar pedido",
  "el modal conserva botón Continuar pedido"
);

contiene(
  "src/modules/cliente/components/PedidoCliente.jsx",
  'useState("restaurante")',
  "Restaurante queda abierto por defecto para cliente especial"
);
...
contiene(
  ...
  "el aviso visual se limita a Cliente especial activo"
);
contieneRegex(
  "src/modules/cliente/components/PedidoCliente.jsx",
  /clienteEspecialAplicado\s*&&\s*clienteEspecialAplicado\.sin_restriccion_acompanantes\s*!==\s*false/,
  "cliente especial puede omitir mínimo de acompañantes"
);
contieneRegex(
  "src/modules/cliente/components/PedidoCliente.jsx",
  /clienteEspecialAplicado\s*&&\s*clienteEspecialAplicado\.habilita_cafeteria\s*!==\s*false/,
  "cliente especial habilita Cafetería cuando la regla lo permite"
);

const pedidoCliente = leer("src/modules/cliente/components/PedidoCliente.jsx");
ok(
  !pedidoCliente.includes("Puedes continuar el pedido sin seleccionar acompañantes manualmente."),
  "se eliminó el texto largo del aviso de cliente especial"
);

contiene(
  "src/modules/cliente/components/CafeteriaClienteEspecial.jsx",
  "cargarCatalogoProductosAdmin",
  "Cafetería carga catálogo dinámico"
);
contiene(
  "src/modules/cliente/components/CafeteriaClienteEspecial.jsx",
  "PRODUCTOS_CATALOGO_FALLBACK",
  "Cafetería conserva fallback local"
);
contiene(
  "src/modules/cliente/components/CafeteriaClienteEspecial.jsx",
  "productoEsCafeteria",
  "Cafetería filtra productos por línea"
);

contiene(
  "src/shared/hooks/usePedidos.js",
  "normalizarClienteEspecialParaPedido(clienteEspecialAplicado)",
  "el pedido normaliza cliente especial antes de guardar"
);
contiene(
  "src/shared/hooks/usePedidos.js",
  "cliente_especial: clienteEspecialPedido || undefined",
  "cada item guarda referencia cliente_especial"
);
contiene(
  "src/shared/utils/pedidos.js",
  "normalizarClienteEspecialParaPedido",
  "existe normalizador de cliente especial"
);
contiene(
  "src/shared/utils/pedidos.js",
  "obtenerClienteEspecialPedido",
  "existe lector de cliente especial en pedidos"
);
contiene(
  "src/modules/cliente/components/ConfirmacionPedidoCliente.jsx",
  "Cliente especial aplicado",
  "confirmación muestra cliente especial aplicado"
);

contiene(
  "src/shared/utils/pedidos.js",
  "Este Producto viene con acompañantes del día",
  "mensaje de acompañantes del día se mantiene"
);
contieneRegex(
  "src/shared/utils/pedidos.js",
  /nombre\.includes\("pasta"\)/,
  "Pastas dentro de Platos se detectan por nombre"
);
...
contieneRegex(
  ...
  /(124\.(44|45)|12[5-9]\.[0-9]+|1[3-9][0-9]\.[0-9]+)-/,
  "versión de build mantiene línea 124.44 o versión posterior"
);
contieneRegex(
  "public/rafiki-version.json",
  /(124\.(44|45)|12[5-9]\.[0-9]+|1[3-9][0-9]\.[0-9]+)-/,
  "versión pública mantiene línea 124.44 o versión posterior"
);
